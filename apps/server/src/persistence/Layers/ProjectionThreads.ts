    ...
    execute: (row) =>
      sql`
        INSERT INTO projection_threads (
          ...
          summary_basis_message_count,
          summary_basis_turn_id,
          summary_basis_activity_count,
          summary_basis_last_message_at,
          summary_generation_request_id,
          summary_generation_started_at,
        ...
        VALUES (
          ...
          ${row.summaryBasisTurnId ?? null},
          ${row.summaryBasisActivityCount ?? null},
          ${row.summaryBasisLastMessageAt ?? null},
          ${row.summaryGenerationRequestId ?? null},
          ${row.summaryGenerationStartedAt ?? null},
        ...
        DO UPDATE SET
          ...
          summary_basis_message_count = excluded.summary_basis_message_count,
          summary_basis_turn_id = excluded.summary_basis_turn_id,
          summary_basis_activity_count = excluded.summary_basis_activity_count,
          summary_basis_last_message_at = excluded.summary_basis_last_message_at,
          summary_generation_request_id = excluded.summary_generation_request_id,
          summary_generation_started_at = excluded.summary_generation_started_at,
