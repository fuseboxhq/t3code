...
describe("OrchestrationReactor", () => {
  ...
  it("starts provider ingestion, provider command, checkpoint, thread deletion, and summary reactors", async () => {
    ...
    runtime = ManagedRuntime.make(
      Layer.effect(OrchestrationReactor, makeOrchestrationReactor).pipe(
        ...
        Layer.provideMerge(
          Layer.succeed(ThreadSummaryReactor, {
            start: () => {
              started.push("thread-summary-reactor");
              return Effect.void;
            },
            drain: Effect.void,
          }),
