...
import { Route as ChatLeadsRouteImport } from './routes/_chat.leads'
...
const ChatLeadsRoute = ChatLeadsRouteImport.update({
  id: '/leads',
  path: '/leads',
  getParentRoute: () => ChatRoute,
} as any)
...
export interface FileRoutesById {
  ...
  '/settings': typeof SettingsRouteWithChildren
  '/usage': typeof UsageRoute
  '/_chat/leads': typeof ChatLeadsRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_chat/leads': {
      ...
      path: '/leads'
      fullPath: '/leads'
      preLoaderRoute: typeof ChatLeadsRouteImport
      parentRoute: typeof ChatRoute
    }
    '/_chat/draft/$draftId': {
...
interface ChatRouteChildren {
  ChatLeadsRoute: typeof ChatLeadsRoute
