              ...
              {showProjectIdentity ? (
                <>
                  <ProjectFavicon
                    ...
                    className="size-4 shrink-0"
                  />
                  {(props.projectDisplayName ?? props.projectTitle) ? (
                    <span
                      className={cn(
              ...
              <div className="flex items-center gap-1">
                ...
                >
                  ...
                  >
                    ...
                    {projectScopeKey === null ? (
                      <label className="flex min-h-9 items-center gap-3 border-t border-border/70 px-3 text-sm">
                        <span className="min-w-0 flex-1">Group active threads by project</span>
                        <Switch
